...
<html lang="en">
	<head>
		...
		<link rel="icon" href="<?php echo e(asset('img/logoProyecto.png')); ?>">
	</head>
	<body>
		...
		<main class="main-content">
				...
				<div class="container-products">
					...
					<div class="card-product">
						<div class="container-img">
							<img
								src="<?php echo e(asset('img/proye3.jpg')); ?>"
					...
					<div class="card-product">
						<div class="container-img">
							<img
								src="<?php echo e(asset('img/proye2.jpg')); ?>"
					...
					<div class="card-product">
						<div class="container-img">
							<img src="<?php echo e(asset('img/proyecto4.jpg')); ?>" alt="Cafe Helado" />
							<div class="button-group">
								<span>
									<i class="fa-regular fa-eye"></i>
								</span>
			...
			<section class="gallery">
				<img
					src="<?php echo e(asset('img/galeri1.jpg')); ?>"
					alt="Gallery Img1"
					class="gallery-img-1"
				/><img
					src="<?php echo e(asset('img/galeria2.jpg')); ?>"
					alt="Gallery Img2"
					class="gallery-img-2"
				/><img
					src="<?php echo e(asset('img/galeri3.jpg')); ?>"
					alt="Gallery Img3"
					class="gallery-img-3"
				/><img
					src="<?php echo e(asset('img/galeri4.jpg')); ?>"
					alt="Gallery Img4"
					class="gallery-img-4"
				/><img
					src="<?php echo e(asset('img/galeria5.jpg')); ?>"
					alt="Gallery Img5"
					class="gallery-img-5"
				/>
			</section>
...
<?php /**PATH D:\laragon\www\DonateHappiness\resources\views/index.blade.php ENDPATH**/ ?>